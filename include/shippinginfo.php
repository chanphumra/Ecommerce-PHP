                            ...
                            <div class="mx-n2">
                                <div class="row align-items-center mb-2 g-3">
                                    <div class="col-8 col-md-7 col-lg-8">
                                        <div class="d-flex align-items-center"><img class="me-2 ms-1" src="../admin/assets/img/products/1.png" width="40" alt="" />
                                ...
                                <div class="row align-items-center mb-2 g-3">
                                    <div class="col-8 col-md-7 col-lg-8">
                                        <div class="d-flex align-items-center"><img class="me-2 ms-1" src="../admin/assets/img/products/2.png" width="40" alt="" />
                                ...
                                <div class="row align-items-center mb-5 g-3">
                                    <div class="col-8 col-md-7 col-lg-8">
                                        <div class="d-flex align-items-center"><img class="me-2 ms-1" src="../admin/assets/img/products/3.png" width="40" alt="" />
